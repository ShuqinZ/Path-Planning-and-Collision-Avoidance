...
%                     hold on;
    ...
    %                     nearByDrones = [nearByDrones, drones(i)];
            ...
            while potentialCollide
                ...
                apf = APF(sizeOfIllumCell * dispCellSize);
    ...
    %                     end
                        ...
                        if targetExchange && colDronesPerTime(i).targetExchangeCounter >= 1
                            ...
                            if waypointsPerStep(checkPosition(targetExchange,4),13)
                                ...
                                waypointsPerStep(checkPosition(targetExchange,4),10:12) = newDroneTarget;
                            end
                        ...
                        if norm(colDronesPerTime(i).position(:)-colDronesPerTime(i).target(:)) <= sizeOfIllumCell * dispCellSize
